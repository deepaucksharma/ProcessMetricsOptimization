module github.com/deepaksharma/helloprocessor/processor
...
require (
	...
	github.com/opentelemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.80.0 // indirect
